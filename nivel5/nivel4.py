...
def juego():
    ...
    titulo_inicio = "NIVEL 4: BATALLA FINAL"
    subtitulo_inicio = "ENFRENTAMIENTO CONTRA EL SEÑOR DEL CAOS"
    
    historia_inicio = (
        "El Señor del Caos ha revelado su verdadero poder: 3 fases de transformación "
        "cada una más letal que la anterior. En cada fase, desbloquea nuevos ataques "
        "masivos con patrones complejos al estilo Cuphead. Bolas de fuego gigantes, "
        "láseres horizontales, ondas expansivas y tetrominos mortales te esperan. "
        "Cada 12 segundos, invocará piezas de Tetris. ¡Prepárate para la "
        "batalla más épica y desafiante de tu vida!"
    )
    
    titulo_final = "LEYENDA CÓSMICA"
    subtitulo_final = "HAS DOMINADO EL CAOS"
    
    historia_final = (
        "Contra todo pronóstico, has vencido al Señor del Caos en sus 3 fases "
        "de transformación. Tu habilidad para esquivar patrones complejos y ataques "
        "masivos te ha convertido en una leyenda. El universo respira aliviado "
        "mientras la energía caótica se disipa en el vacío interestelar. Tu nombre "
        "será recordado por eones como el piloto que enfrentó lo inconcebible "
        "y emergió victorioso. El equilibrio cósmico ha sido restaurado... "
        "¿o hay algo más oscuro esperando en la profundidad del espacio?"
    )
